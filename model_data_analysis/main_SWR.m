                                                                    ...
                                                                    for rate_ext_E = [0.85] % 0.85
                                                                        for  tau_c_EE = [8]
                                                                            ...
                                                                            for tau_c_I = [20]
                                                                                ...
                                                                                post_dist = lattice_nD_find_dist(Lattice,hw,887);
                                                                                [~,IndP] = sort(post_dist);
                                                                                I_ext_mean(IndP(1:50)) = 1;
                                                                                mean_TV(2e4:2.05e4) = 2;
...
%                                                                                 writeExtCurrentTimeVariantSettingsHDF5_YL(FID,1,I_ext_mean,I_ext_std,mean_TV,std_TV,meanTWO,mean_TVTWO,meanTHREE,mean_TVTHREE);
                                                                                ...
                                                                                % write synapse para
                                                                                writeSynParaHDF5(FID,'tau_decay_GABA', decay_GABA);
                                                                                ...
                                                                                K_ee = ModifyLocalEE(I_ee,J_ee,K_ee,Kw,d); % ,pr);
                                                                                K_ee_mean = mean(K_ee);
                                                                                ...
                                                                                if SP_on == 1
                                                                                    writeSPHDF5(FID,1,1,1,tau_D,tau_F);
                                                                                end
                                                                                ...
                                                                                [Lattice, ~] = lattice_nD(2, hw);
                                                                                LFP_neurons = [];
                                                                                LFP_centre_x = linspace(-hw,hw,63); % E16:9  E100:21 E400:41 E1600:81 E3969:63
