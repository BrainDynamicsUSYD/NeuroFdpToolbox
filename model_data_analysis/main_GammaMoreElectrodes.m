function main_GammaMoreElectrodes(varargin)
                                                            ...
                                                            for rate_ext_E = [0.85 ]
                                                                for  tau_c_EE = [8] % the three are exponential distance dependent time constants
                                                                    ...
                                                                    for tau_c_I = [20]
                                                                        ...
                                                                        LFP_centre_x = linspace(-hw, hw, 30);
                                                                        LFP_centre_y = linspace(-hw, hw, 30);
                                                                        LFP_centre_x = LFP_centre_x(2:3:29);
                                                                        LFP_centre_y = LFP_centre_y(2:3:29);
