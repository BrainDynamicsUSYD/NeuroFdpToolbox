...
% synaptic plasticity
STD_on = 0;
SP_on = 0; % need to get two subfunctions consistent
                                                            ...
                                                            for g_II = [25]*10^-3 % 25
                                                                for rate_ext_I = [1] % 1 kHz
                                                                    for rate_ext_E = [0.85] % 0.85
                                                                        % rate_ext_E = rate_ext_E*ones(1, step_tot);
                                                                        % rate_ext_E(2e4:2.35e4) = 1.1;
...
%                                                                                 writeNeuronSamplingHDF5(FID, sample_pop, [0,0,1,0,0,0,1,0],1:N(1), ones(1, step_tot))
                                                                                % writeNeuronSamplingHDF5(FID, sample_pop, [1,1,1,1,0,0,1,1], sample_neurons, ones(1, step_tot) )
                                                                                % writeNeuronSamplingHDF5(FID, 2, [1,1,1,1,0,0,1,1], [1 100], ones(1, step_tot) )
                                                                                
                                                                                % Add LFP sampling
                                                                                [Lattice, ~] = lattice_nD(2, hw);
                                                                                LFP_neurons = [];
                                                                                LFP_centre_x = linspace(-hw,hw,9); % E16:9  E100:21 E400:41 E1600:81 E3969:127
                                                                                LFP_centre_y = linspace(-hw,hw,9);
                                                                                LFP_centre_x = LFP_centre_x(2:2:8); % E16(2:2:8)  E100(2:2:20) E400(2:2:40) E1600(2:2:80) E3969(2:2:126)
                                                                                ...
                                                                                %  'K_ee_mean', 'LFP_centre_x', 'LFP_centre_y'); % ,'IndC','all','Indegree');
