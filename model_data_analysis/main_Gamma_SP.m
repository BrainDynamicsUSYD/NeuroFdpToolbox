function main_Gamma_SP(varargin)
...
%%% initialize time_neuron variable stimulus
    ...
    for NumP = [4]
        ...
        switch NumP
            ...
            case 3
                IndC = [961 992 2930];
            case 4
                IndC = [961 992 2914 2945];
            case 5
                IndC = [961 992 2914 2945 1985];
            case 6
                IndC = [1465 1496 2410 2441 536 3434];
            case 7
                IndC = [1465 1496 2410 2441 536 3434 1985];
        end
        Stogether = 1;
                                ...
                                for LFP_range_sigma = [8] % 8
                                    for cn_scale_wire = [2] % 2
                                        for cn_scale_weight = [2] % 2
                                            ...
                                            % [ fit_g_2_EPSP_2, ~ ] = g_EPSP_conversion_SP(tau_D,tau_F,U);
                                            for deg_hybrid = [0.4]
                                                degree_CV = 0.2; % 0.2 works
                                                for g_mu = [5]*10^-3 % 4 15
                                                                                ...
                                                                                for tau_c_EE = [8] % the three are exponential distance dependent time constants
                                                                                    ...
                                                                                    for tau_c_I = [20]
                                                                                        for backgroundcoe = [1]
                                                                                            ...
                                                                                            % g_pool_generator_hld = @(N)g_pool_generator_SP(N,mu_p,s_p,tau_D,tau_F,U);
                                                                                            ...
                                                                                            [K_ee,StiNeu] = WorkingMemoryLocalPopulation(IndC,hw,Lattice_E,I_ee,J_ee,K_ee,Kw,LP);
                                                                                            K_ee_mean = mean(K_ee);
                                                                                            ...
                                                                                            % I_ext_mean(StiNeu{1}) = 5;
                                                                                            % meanTWO(StiNeu{2}) = 5;
                                                                                            % meanTHREE(StiNeu{3}) = 5;
                                                                                            % mean_TV(2e4:2.35e4) = 1; % 2e4:2.35e4
                                                                                            % mean_TVTWO(4e4:4.35e4) = 1;
                                                                                            % mean_TVTHREE(6e4:6.35e4) = 1;
...
%                                                                                                 'K_ee_mean', 'LFP_centre_x', 'LFP_centre_y','IndC','StiNeu'); % ,'I_ee','J_ee','K_ee','D_ee');
                                                                                            ...
                                                                                            save([sprintf('%04g-', loop_num), datestr(now,'yyyymmddHHMM-SSFFF'),...
                                                                                                '_config_data.mat'],'IndC','StiNeu','I_ee','J_ee'); 
