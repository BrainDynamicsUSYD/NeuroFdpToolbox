function [ g, g_info ] = g_pool_generator_SP( N, mu_p, s_p,tau_D,tau_F,U)
...
% xlim([-2,1]);
% 
% [ ~, fit_EPSP_2_g ] = g_EPSP_conversion_SP( 0.01:0.01:1 );
...
[ ~, fit_EPSP_2_g ] = g_EPSP_conversion_SP(tau_D,tau_F,U);
