function pattDetection_v3(sigIn, sigBinary, params, flagMovie, flagSaveData,saveFileName)
...
CC = bwconncomp(sigBinary,18) ;               % continued points in space-time
