function job_burst_pattern_3D_zscore(arrayID)
cd ..
...
bandpassSig = find_bandpassSig(surSig,subBand, fsTemporal,3,badChannels,1) ;
...
makeMovie = 1;
if makeMovie
    vidTitle = [pwd,'/Results/movies/Zscore',dataFileName,'_', num2str(boundPrctile) ,'%_',...
