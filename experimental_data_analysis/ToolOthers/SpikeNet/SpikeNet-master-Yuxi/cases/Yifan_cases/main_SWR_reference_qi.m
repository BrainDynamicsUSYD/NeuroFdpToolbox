function main_SWR_reference_qi(varargin)
% Do it!!!
% Find it!!!
% Hunt it down!!!
                                            ...
                                            for rate_ext_I = [1];
                                                ...
                                                for  tau_c_EE = [8]
                                                    ...
                                                    for tau_c_I = [20]
                                                        ...
                                                        writeExtSpikeSettings(FID, 1, 1, g_ext,  N_ext, rate_ext_E*ones(1, step_tot),  ones(1, N(1)) );
                                                        writeExtSpikeSettings(FID, 2, 1, g_ext,  N_ext, rate_ext_I*ones(1, step_tot),  ones(1, N(2)) );
