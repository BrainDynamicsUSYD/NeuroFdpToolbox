function main_SWR_reference_quenched(varargin)
% Do it!!!
% Find it!!!
% Hunt it down!!!
                    ...
                    for deg_hybrid = [0.4 ]
                        ...
                        for g_mu = [4]*10^-3;
                            ...
                            for inh_STDP = [0 ];
                                ...
                                for g_balance = 0.8:0.05:1.1 %[0.9 0.95]
								...
								rng(1)   
                                                                ...
                                                                for pop_ind = 1:Num_pop
                                                                    writePopSeedHDF5(FID, pop_ind, pop_ind+123); 
                                                                end
                                                                % write external currents
                                                                writeExtSpikeSettingsHDF5(FID, 1, 1, g_ext,  N_ext, rate_ext_E*ones(1, step_tot),  ones(1, N(1)), 123 );
                                                                writeExtSpikeSettingsHDF5(FID, 2, 1, g_ext,  N_ext, rate_ext_I*ones(1, step_tot),  ones(1, N(2)), 122 );
