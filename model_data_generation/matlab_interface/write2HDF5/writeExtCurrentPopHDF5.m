function writeExtCurrentPopHDF5(FID, fname,pop_ind)
...
% hdf5write(FID,['/config/pops/pop',num2str(pop_ind),'/file_current_input/fname'],fname,'WriteMode','append');
...
%
group = H5G.create (file, ['/config/pops/pop',num2str(pop_ind),'/file_current_input'], gcpl,'H5P_DEFAULT', 'H5P_DEFAULT');
...
% it.
%
dset = H5D.create (file, ['/config/pops/pop',num2str(pop_ind),'/file_current_input/fname'], filetype, space, 'H5P_DEFAULT');
