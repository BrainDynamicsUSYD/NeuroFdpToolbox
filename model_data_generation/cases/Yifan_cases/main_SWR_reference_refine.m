function main_SWR_reference_refine(varargin)
% Do it!!!
% Find it!!!
% Hunt it down!!!
                    ...
                    for deg_hybrid = [0.4 ]
                        ...
                        for g_mu = [4]*10^-3;
                            ...
                            for inh_STDP = [0 ];
                                ...
                                for g_EI = [ 13 13.5 14 ]*10^-3 %11 12
                                    for g_IE = [5 5.5 6.0]*10^-3
                                        for g_II = [25]*10^-3
                                            
                                            for rate_ext_I = [1];
                                                for rate_ext_E = [0.85 0.9 0.95 1.0];
                                                for  tau_c_EE = [8]
                                                    tau_c_IE = 10;
                                                    for tau_c_I = [20]
                                                        loop_num = loop_num + 1;
                                                        ...
                                                        for cc = 1:length(LFP_centre_x)
                                                            ...
                                                            LFP_neurons = [LFP_neurons; transpose(dist <= LFP_range)]; %#ok<AGROW>
                                                        end
